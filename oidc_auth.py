        ...
        if discovery_url:
            try:
                ...
                if response.status_code == 200:
                    ...
                    app.logger.info("OIDC configuration loaded from discovery endpoint")
                ...
                app.logger.error(f"Error loading OIDC discovery document: {e!s}")
...
def register_oidc_routes(app, User, db):
    ...
    def login_oidc():
        ...
        try:
            ...
            current_app.logger.error(f"Error initiating OIDC authentication: {e!s}")
    ...
    def logout_oidc():
        ...
        if logout_endpoint and has_oidc and id_token:
            try:
                ...
                current_app.logger.error(f"Error during OIDC logout redirect: {e!s}")
