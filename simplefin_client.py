...
class SimpleFin:
    ...
    def decode_setup_token(self, setup_token):
        ...
        try:
            ...
            self.app.logger.error(f"Error decoding token: {e!s}")
    ...
    def claim_access_url(self, claim_url):
        ...
        try:
            ...
            self.app.logger.error(f"Error claiming access URL: {e!s}")
            return None
    ...
    def parse_access_url(self, access_url):
        ...
        try:
            ...
            self.app.logger.error(f"Error parsing access URL: {e!s}")
            return None
    ...
    def create_transactions_from_account(self, account_data, db_account, user_id,
        ...
        for trans in account_data.get('transactions', []):
            try:
                ...
                self.app.logger.error(f"Error creating transaction: {e!s}")
    ...
    def create_transaction_instance(self, trans_data, db_account, user_id,
        ...
        try:
            ...
            self.app.logger.warning(f"Could not check for existing transaction: {e!s}")
        ...
        if transaction_type != 'transfer':
            ...
            if auto_categorize_func:
                try:
                    ...
                    self.app.logger.error(f"Error in auto-categorization: {e!s}")
